...
go test -v -coverprofile=utils_tests.out -covermode=atomic -coverpkg=./ ./utils/

go test -v -coverprofile=helpers_tests.out -covermode=atomic -coverpkg=./ ./tests/helpers/
