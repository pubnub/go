...
func (b *getChannelsBuilder) EntityClassLevel(level PNEntityClassLevel) *getChannelsBuilder {
...
func (b *getChannelsBuilder) FilterFast(filterFast string) *getChannelsBuilder {
