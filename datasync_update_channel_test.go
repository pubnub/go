...
func TestUpdateChannelBuildPathQueryBody(t *testing.T) {
	assert := assert.New(t)
...
func TestUpdateChannelHTTPMethodAndOperation(t *testing.T) {
	assert := assert.New(t)
	pn := NewPubNub(NewDemoConfig())
	o := newUpdateChannelBuilder(pn)
...
func TestUpdateChannelValidate(t *testing.T) {
	assert := assert.New(t)
	pn := NewPubNub(NewDemoConfig())
...
func TestUpdateChannelExecuteValidationError(t *testing.T) {
	assert := assert.New(t)
	pn := NewPubNub(NewDemoConfig())
