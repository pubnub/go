...
type fetchUserBuilder struct {
	opts *fetchUserOpts
}

func newFetchUserBuilder(pubnub *PubNub) *fetchUserBuilder {
	builder := fetchUserBuilder{
		opts: &fetchUserOpts{
			pubnub: pubnub,
		},
	}
...
func newFetchUserBuilderWithContext(pubnub *PubNub,
	context Context) *fetchUserBuilder {
	builder := fetchUserBuilder{
		opts: &fetchUserOpts{
			pubnub: pubnub,
			ctx:    context,
...
func (b *fetchUserBuilder) Include(include []string) *fetchUserBuilder {
...
// Auth sets the Authorization key with permissions to perform the request.
func (b *fetchUserBuilder) Id(id string) *fetchUserBuilder {
	b.opts.Id = id
...
func (b *fetchUserBuilder) QueryParam(queryParam map[string]string) *fetchUserBuilder {
...
func (b *fetchUserBuilder) Transport(tr http.RoundTripper) *fetchUserBuilder {
	b.opts.Transport = tr
	return b
}

// Execute runs the fetchUser request.
func (b *fetchUserBuilder) Execute() (*PNFetchUserResponse, StatusResponse, error) {
